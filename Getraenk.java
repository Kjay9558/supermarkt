...
public class Getraenk extends Ware {
    ...
    public Getraenk(double preis, int artikelnummer, String name,
                    short altersfreigabe, String hersteller, double alkgehalt,
                    int kalorien, double volumen, boolean kohlensaeure) {
